package com.example.foodswipe.DeliveryFoodPanel;
...
import com.example.foodswipe.SendNotification.APIService;
import com.example.foodswipe.SendNotification.Client;
import com.example.foodswipe.SendNotification.Data;
import com.example.foodswipe.SendNotification.MyResponse;
import com.example.foodswipe.SendNotification.NotificationSender;
...
public class DeliveryPendingOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryPendingOrderFragmentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mobilenumber.setText("+974" + deliveryShipOrders1.getMobileNumber());
