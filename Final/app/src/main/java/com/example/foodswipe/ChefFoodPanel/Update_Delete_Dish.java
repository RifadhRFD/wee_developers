package com.example.foodswipe.ChefFoodPanel;
...
import com.example.foodswipe.Chef;
import com.example.foodswipe.ChefFoodPanel_BottomNavigation;
...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).removeValue();  //.child(City).child(Sub)
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(useridd).child(ID);  //.child(City).child(Sub)
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State)
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID)
                .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {     //.child(City).child(Sub)
            @Override
