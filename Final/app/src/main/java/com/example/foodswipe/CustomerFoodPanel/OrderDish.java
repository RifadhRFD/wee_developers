package com.example.foodswipe.CustomerFoodPanel;
...
import com.example.foodswipe.ChefFoodPanel.UpdateDishModel;
import com.example.foodswipe.Customer;
import com.example.foodswipe.CustomerFoodPanel_BottomNavigation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(ChefID).child(RandomId);     //.child(City).child(Sub)
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (ChefID.equals(cart1.getChefId())) {
                                        data = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(ChefID).child(RandomId);   //.child(City).child(Sub)
