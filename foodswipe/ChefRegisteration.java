...
import com.example.foodswipe.ReusableCode.ReusableCodeForAll;
...
//    String[] Kalutara = {"Beruwala", "Aluthgama", "Kalutara South"};
//    String[] Colombo = {"Kollupitiya", "Bambalapitya", "Wellawatte"};
//    String[] Gampaha = {"Negombo", "Gampaha Town", "Wattala"};


    TextInputLayout Fname, Lname, Email, Pass, cfpass, mobileno, houseno, Address1, postcode;
   ...
   // String cityy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   houseno = (TextInputLayout) findViewById(R.id.houseNo);
        Address1 = (TextInputLayout) findViewById(R.id.Address);
     //   postcode = (TextInputLayout) findViewById(R.id.Postcode);
       statespin = (Spinner) findViewById(R.id.District);
...
//        });
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                address1 = Address1.getEditText().getText().toString().trim();
                            ...
                            if (task.isSuccessful()) {
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        hashMappp.put("Address", address1);    //
...
//        postcode.setError("");
        ...
        boolean isValidname = false, isValidemail = false, isvalidpassword = false, isvalidconfirmpassword = false, isvalid = false, isvalidmobileno = false, isvalidlname = false, isvalidarea = false;  //isvalidhousestreetno = false,, isvalidpostcode = false
...
//        }
        ...
        isvalid = ( isValidname  && isvalidlname && isValidemail && isvalidconfirmpassword && isvalidpassword && isvalidmobileno && isvalidarea ) ? true : false;  // && isvalidpostcode  && isvalidhousestreetno
        return isvalid;
    }
