...
import com.example.foodswipe.MainMenu;
...
public class ChefHomeFragment extends Fragment {
    ...
    private String District, City, Sub;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Food Swipe");
    ...
    private void chefDishes() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(useridd);  // .child(District).child(City).child(Sub)
