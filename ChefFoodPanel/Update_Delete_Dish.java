...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).removeValue();  //.child(State).child(City).child(Sub)
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(useridd).child(ID);   // child(State).child(City).child(Sub).
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("FoodSupplyDetails")
                ...
                .setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {        //.child(State).child(City).child(Sub)
            @Override
